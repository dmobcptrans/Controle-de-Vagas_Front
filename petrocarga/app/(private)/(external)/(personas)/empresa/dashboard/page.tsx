...
import { getEmpresaByUsuarioId } from '@/lib/api/empresaApi';
...
import { MotoristaEmpresa } from '@/lib/types/empresa';
 ...
 * @version 1.0.0
 *
 * @description Página principal (dashboard) do empresa.
 ...
 *
 * 1. HEADER:
 *    - Saudação personalizada com nome do empresa
    ...
    <div className="min-h-screen bg-[#f5f5f0]">
      ...
      <main className="px-4 sm:px-8 pb-16 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-5">
          {/* ---------- ÚLTIMAS RESERVAS (esquerda, ocupa 2 colunas) ---------- */}
          <div className="lg:col-span-2 bg-white border border-gray-100 rounded-2xl shadow-sm p-4 sm:p-5">
            <div className="flex items-center justify-between pb-3 mb-3 border-b border-gray-100">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 bg-[#1351B4]/10 rounded-lg flex items-center justify-center">
                  <Archive className="h-3.5 w-3.5 text-[#1351B4]" />
                </div>
                  ...
                  >
                    ...
                    <span
                      className={`w-2 h-2 rounded-full shrink-0 ${
                        m.ativo ? 'bg-green-500' : 'bg-gray-300'
                      }`}
