 ...
 * @version 1.0.0
 *
 * @description Página de visualização do perfil do gestor.
 * Exibe informações pessoais e permite edição e configuração de notificações.
 *
 * ----------------------------------------------------------------------------
 * 📋 FLUXO COMPLETO:
 * ----------------------------------------------------------------------------
 ...
 *       - API retornou sucesso mas gestor = null
 ...
 *   - Gestor não tem matrícula (campo removido)
 *   - Grid de 2 colunas (em vez de 3 do agente)
 *   - Dados diretos no objeto gestor (não aninhados em usuario)
 *
 * - LAYOUT SIMPLIFICADO:
 *   - Grid 2 colunas para melhor aproveitamento
 *   - Cards com ícones coloridos
 *   - Textos responsivos
 *
 * - COMPONENTES REUTILIZÁVEIS:
 *   - PushNotificationToggle (mesmo do agente)
 *   - Link para edição
 *
 * ----------------------------------------------------------------------------
 ...
 * - /gestor/perfil/editar-perfil: Página de edição
 *
 * @example
    ...
    <main className="container mx-auto px-3 sm:px-4 py-4 md:py-8 min-h-[calc(100vh-4rem)]">
      <Card className="w-full max-w-4xl mx-auto shadow-sm md:shadow-lg">
        ...
        <div className="px-4 sm:px-6 pb-6 space-y-6">
          {/* Grid de informações (4 cards em 2 colunas) */}
