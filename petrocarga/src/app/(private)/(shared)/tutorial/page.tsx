 ...
 * - /reservar-vaga: Página de reserva (CTA)
 *
 * @example
 * ```tsx
 ...
 * ```
 *
 * @see /components/tutorial/tutorial.tsx - Componente base
 * @see /components/tutorial/personas/secoesMotorista.ts - Configuração de seções
 */
