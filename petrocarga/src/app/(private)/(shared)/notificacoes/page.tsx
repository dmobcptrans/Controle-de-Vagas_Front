 ...
 * ```
 *
 * @see /context/NotificationContext.tsx - Contexto de notificações
 * @see /components/notification/notificationHeader.tsx - Header
 * @see /components/notification/notificationList.tsx - Lista
 */
