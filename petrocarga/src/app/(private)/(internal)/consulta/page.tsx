 ...
 * <ConsultarPlacaPage />
 *
 * @see /lib/api/reservaApi.ts - Integração com backend
 * @see /components/agente/cards/reservaPlaca-card.tsx - Card de reserva
 * @see /lib/types/reservaPlaca.ts - Tipagem das reservas
 */
