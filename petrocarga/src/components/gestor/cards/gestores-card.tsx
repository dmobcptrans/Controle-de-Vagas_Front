...
export default function GestorCard({
    ...
    try {
      ...
      toast.error(
        err instanceof Error
          ? err.message
          : 'Erro ao desativar gestor. Tente novamente.',
      );
    } finally {
      setIsUpdating(false);
    }
   ...
   * @description Processa a ativação (reativação) do gestor usando a API reativarUsuario
   *
   * Fluxo:
   * 1. Chama API reativarUsuario com ID do gestor
   * 2. Se sucesso: fecha modal e atualiza lista via callback
   * 3. Se erro: exibe toast de erro
   */
  const handleAtivar = async () => {
    ...
    try {
      ...
      toast.error(
        err instanceof Error
          ? err.message
          : 'Erro ao ativar gestor. Tente novamente.',
      );
    } finally {
      setIsUpdating(false);
    }
  ...
  return (
    <>
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h3 className="font-semibold text-gray-900 truncate leading-none">
                ...
                {gestor.usuario.nome.split(' ').at(-1)}
              </h3>
      ...
      <ModalConfirmacaoExclusao
        ...
        mensagem="Quer mesmo desativar este(a) gestor(a)?"
        tipo="exclusao"
      />
      ...
      <ModalConfirmacaoExclusao
        ...
        mensagem="Quer mesmo ativar este(a) gestor(a)?"
