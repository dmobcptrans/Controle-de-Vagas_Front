...
type VeiculoDetalhesProps = {
  ...
  onVeiculoAtualizado?: (veiculoAtualizado: VeiculoResponse) => void;
};

/**
 * @component VeiculoDetalhes
 * @version 2.0.0 (usando useVeiculos)
 *
 * @description Componente de detalhes e edição de veículo.
 * Loading/erro de salvar e excluir agora vêm do hook useVeiculos,
 * então não há mais try/catch manual nem estado de loading próprio.
 */
